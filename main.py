...
.stat-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:8px}.macro-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px}.macro-card{background:var(--card);border:1px solid var(--line);border-radius:16px;padding:13px;box-shadow:var(--shadow)}.macro-name{font-size:10px;color:var(--muted);font-weight:800}.macro-price{font-size:19px;font-weight:850;margin-top:5px}.macro-change{font-size:11px;font-weight:800;margin-top:3px}.impact-row{display:flex;justify-content:space-between;gap:8px;padding:10px 0;border-top:1px solid var(--line);font-size:11px}.session-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.session{background:#f7f8fa;border-radius:13px;padding:11px}.session b{display:block;font-size:13px}.session span{display:block;font-size:10px;color:var(--muted);margin-top:3px}.news-item{padding:12px 0;border-top:1px solid var(--line)}.news-item:first-child{border-top:0;padding-top:0}.news-title{font-size:13px;font-weight:800;line-height:1.35}.news-meta{font-size:10px;color:var(--muted);margin-top:5px}.news-link{color:inherit;text-decoration:none}.stat{background:#f7f8fa;border-radius:12px;padding:10px}.stat span{font-size:10px;color:var(--muted)}.stat b{display:block;font-size:14px;margin-top:4px}
